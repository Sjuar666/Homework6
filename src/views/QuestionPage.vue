...
<template>
  ...
  <div v-if="question" class="flex h-full w-full flex-col item-center gap-8 p-10">
    ...
    :key="answer.id" 
    class="bg-green-500 flex items-center justrify-center text-4xl rounded-lg text-white py-10 px-2">
      </div>
  </div>
  </div>
  <div v-else class="">
